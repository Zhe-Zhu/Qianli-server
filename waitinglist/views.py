    ...
    try:
        ...
        if user.verified:
            ...
            try:
                ...
                pass
            QLUser.objects.create(udid=udid, phone_number=number, password=number, email="", avatar=None, large_avatar=None, name=number, os_type="i")
...
def sendEnterNotificationBySMS(phone_number):
    ...
    data={
        "mobile": phone_number,
        "message": ''.join(["恭喜您已经获得进入千里的资格了！马上打开千里看看吧！", "【千里】"])
